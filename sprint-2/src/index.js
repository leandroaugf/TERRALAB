...
const user = (0, user_1.createUser)({ id: "", age: 21, name: 'John Doe', email: "johndoe@icloud.com" });
const bankAccount = (0, bankAccount_1.createBankAccount)(user, { agency: '0001', number: 1 });
