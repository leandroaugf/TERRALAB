...
1. Typescript é uma versão de JavaScript com tipos, como "number", "string" e outros.
...
3. Interfaces são uma forma de definir um formato específico para um objeto: seus atributos e propriedades. 

4. Classes são moldes para objetos: definem um padrão de atributos e métodos que todos os objetos derivados da classe possuem quando criados.

5. Classes são criadas para representar algo do mundo real. Herança, por sua vez, é feita para que uma outra classe derive a classe-pai, de forma a herdar seus atributos e métodos e adicionar outros novos aos já existente.

6. A tipagem forte, sem inferência automática como ocorre no JavaScript puro, deixa o código "sólido", previne erros e facilita a manutenção.
